...
export default function ScrollFloat({
  ...
  useEffect(() => {
    ...
    const clearMotion = () =>
      gsap.set(characters, {
        clearProps: 'opacity,transform,transformOrigin,translate,rotate,scale',
      });
    if (disabled) {
      clearMotion();
      revealChange.current?.(true);
      return;
    }
      ...
      () => {
        ...
        const animation = gsap.to(characters, {
          ...
          scrollTrigger: {
            ...
            onLeaveBack: () => {
              if (!once) revealChange.current?.(false);
            },
          },
        });
  ...
  return (
    <Tag ref={containerRef} className={`scroll-float ${containerClassName}`} aria-label={text}>
