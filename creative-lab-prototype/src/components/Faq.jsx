...
import { faqGroups, filterFaqGroups } from '../data/faq-data.js';

const topicLabels = {
  'files-printing': 'Printing',
  'orders-delivery': 'Orders',
  'photos-rights': 'Usage Rights',
};
...
export default function Faq() {
  ...
  return (
    <section className="lab-faq" id="faqs" aria-labelledby="questions-title">
      <header className="faq-header">
        <h2 className="lab-section-title" id="questions-title">
          Frequently Asked Questions
          <i className="seed-rest" data-seed-anchor="faq" aria-hidden="true" />
        </h2>
      </header>
      <div className="faq-content">
        <div className="faq-toolbar">
          <div className="faq-topics" role="group" aria-label="FAQ topics">
            {[{ id: 'all', title: 'All' }, ...faqGroups].map((group) => (
              ...
              >
                {topicLabels[group.id] || group.title}
              </button>
            ))}
          </div>
          <form
        ...
        <footer className="faq-help">
          ...
          <a
            ...
            rel="noreferrer"
          >
            Visit help center <ArrowUpRight size={16} aria-hidden="true" />
          </a>
        </footer>
      </div>
    </section>
