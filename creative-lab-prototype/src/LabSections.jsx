      ...
      <div className="business-section">
        <div className="business-story">
          ...
          <ul className="business-benefits">
            ...
            <li><CheckCircle size={24} weight="fill" aria-hidden="true"/><span>Your brand, your store, your customers</span></li>
            <li><CheckCircle size={24} weight="fill" aria-hidden="true"/><span>Bring your own manufacturing, or use our network</span></li>
          </ul>
        </div>
        <div className="contact-panel">
          ...
          <form onSubmit={reviewInquiry} onChange={()=>setInquiry(null)}>
            <div className="contact-fields">
              ...
              <label htmlFor="business-company">Company <span className="field-optional">Optional</span><input id="business-company" name="company" autoComplete="organization" placeholder="Company name"/></label>
            </div>
            <label htmlFor="business-goal">What do you want to do?<span className="contact-select"><select id="business-goal" name="goal" required defaultValue=""><option value="" disabled>Choose one...</option><option>Sell custom products in my store</option><option>Integrate Creative Lab into my platform</option><option>Explore a manufacturing partnership</option></select><CaretUpDown size={18} aria-hidden="true"/></span></label>
            <label htmlFor="business-size">Company size<span className="contact-select"><select id="business-size" name="size" required defaultValue=""><option value="" disabled>Choose one...</option><option>Just me</option><option>2–10 people</option><option>11–50 people</option><option>51–200 people</option><option>201+ people</option></select><CaretUpDown size={18} aria-hidden="true"/></span></label>
            <label htmlFor="business-message">Anything else? <span className="field-optional">Optional</span><textarea id="business-message" name="message" rows="3" placeholder="What are you hoping to build?"/></label>
            <div className="contact-submit"><SpecularButton type="submit">Talk to our team <ArrowRight size={18}/></SpecularButton></div>
          </form>
          <p className="contact-reassurance">No spam — we’ll only reach out about integrating Creative Lab.</p>
          {inquiry&&<div className="contact-review" role="status"><Check size={20}/><div><strong>Your inquiry is ready to review</strong><p>Nothing has been sent. Continue on Meshy to contact the team.</p><p>{inquiry.goal}<br/>{inquiry.size}<br/>{inquiry.email}{inquiry.company&&` · ${inquiry.company}`}{inquiry.message&&<><br/>{inquiry.message}</>}</p><a href={official('/about#contact')} target="_blank" rel="noreferrer">Contact Meshy <ArrowUpRight size={14}/></a></div></div>}
        </div>
      </div>
    </section>
